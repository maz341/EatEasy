...
import 'package:eat_easy/screens/details/reviews/review_item_tile.dart';
...
class RestaurantReviewsSheet extends StatelessWidget {
  const RestaurantReviewsSheet({
    Key? key,
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.of(context).push(
            MaterialPageRoute(
              builder: (context) => RestaurantReviewSheet(
...
class RestaurantReviewSheet extends StatefulWidget {
  const RestaurantReviewSheet({Key? key, required this.restaurant})
      : super(key: key);

  final Restaurant restaurant;

  @override
  State<RestaurantReviewSheet> createState() => _RestaurantReviewSheetState();
}

class _RestaurantReviewSheetState extends State<RestaurantReviewSheet> {
